...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func registerNotifications() {
        ...
        category.identifier = "readyCategory"
    ...
    func application(application: UIApplication, handleActionWithIdentifier identifier: String?, forLocalNotification notification: UILocalNotification, completionHandler: () -> Void) {
        ...
        if (identifier! == "yesAction"){
            ...
            mainView.rideIsScheduledLabel.hidden = false
//            mainView.rideTimeLabel.text = notification.userInfo!["fireDate"] as! String
            mainView.rideTimeLabel.hidden = false
